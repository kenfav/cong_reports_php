...
@endif
<div class="w3-modal-content w3-card-4 w3-container w3-padding-16 " style="max-width:600px; margin: auto;">
  <form action="{{route('publicadores.update', $publicador -> id)}}" method="POST">
    ...
    <div class="w3-center">
      <input class="w3-button " type="submit" value="Confirmar">
  </form>
  <form action="{{ route('publicadores.delete', $publicador -> id)}}" method="POST">
    @csrf
    @method('DELETE')
    <input class=" w3-button" type="submit" value="Borrar">
  </form>
</div>
